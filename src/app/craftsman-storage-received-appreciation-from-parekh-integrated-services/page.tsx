...
import DetailPage from "@/components/news-detail/parekh-integrated-services/DetailPage";
import RecentEvents from "@/components/NewsCraftsmanHosted/RecentEvents";
export async function generateMetadata() {
  return getMeta("/craftsman-storage-received-appreciation-from-parekh-integrated-services");
}
    ...
    <div>
      <main className="bg-[linear-gradient(360deg,#ebf7ff_50%,#fff_100%)]">
        ...
        <div className=" rounded-[40px] max-[480px]:pt-[20px] w-[95%] max-w-[105rem] mx-auto relative z-index-[99]">
          <Breadcrumbs pageKey="craftsman-storage-received-appreciation-from-parekh-integrated-services" />
        </div>
        <div className=" overflow-hidden">
          <div className=" rounded-[40px] pt-[20px] w-[95%] max-w-[105rem] mx-auto">
            <SubbannerNews bannerKey="craftsman-storage-received-appreciation-from-parekh-integrated-services" />
          </div></div>
