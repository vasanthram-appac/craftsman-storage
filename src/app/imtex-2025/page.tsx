...
import DetailPage from "@/components/news-detail/imtex-2025/DetailPage";
import RecentEvents from "@/components/NewsCraftsmanHosted/RecentEvents";
export async function generateMetadata() {
  return getMeta("/imtex-2025");
}
