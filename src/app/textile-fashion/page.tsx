...
import Ecommerce from "@/components/CaseStudiesDetail/EcommerceComponent";
import EcommerceSolution from "@/components/CaseStudiesDetail/EcommerceSolutiionComponent";
import TextileIndustry from "@/components/CaseStudiesDetail/TextileIndustryComponent";
import TextileFashion from "@/components/CaseStudiesDetail/TextileFashionComponent";
    ...
    <div>
      <main className="bg-[linear-gradient(360deg,#ebf7ff_50%,#fff_100%)]">
        ...
        <div className="rounded-[40px] max-[480px]:pt-[20px] w-[95%] max-w-[105rem] mx-auto relative z-index-[99]">
          <Breadcrumbs pageKey="textile-fashion" />
        </div>
        <div className="overflow-hidden">
          <div className="rounded-[40px] pt-[20px] w-[95%] max-w-[105rem] mx-auto">
            <Subbanner bannerKey="textile-fashion" />
          </div>
        </div>
