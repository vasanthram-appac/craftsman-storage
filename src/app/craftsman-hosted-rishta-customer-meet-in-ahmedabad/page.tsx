...
import DetailPage from "@/components/News/DetailPage";
import SubbannerNews from "@/components/News/SubbannerNews";
    ...
    <div>
      <main className="bg-[#EBF7FF]">
        ...
        <div className=" rounded-[40px] max-[480px]:pt-[20px] w-[95%] mx-auto relative z-index-[99]">
          <Breadcrumbs pageKey="craftsman-hosted-rishta-customer-meet-in-ahmedabad" />
        </div>
        <div className=" overflow-hidden">
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto">
          <SubbannerNews bannerKey="craftsman-hosted-rishta-customer-meet-in-ahmedabad" />
        </div></div>
