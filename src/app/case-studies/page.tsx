...
import CaseLists from "@/components/CaseStudies/CaseLists";
  ...
  return (
    <div >
      <main className="bg-[#EBF7FF] overflow-hidden">
        <Header />
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto"><Breadcrumbs pageKey="pallet-asrs" /></div>
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto"><Subbanner  bannerKey="pallet-asrs"/></div>
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto"><QuickLinks /></div>
          <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px] rounded-[40px] w-[90%] md:w-[70%] max-w-[105rem] mx-auto">
            <CaseLists />
          </div>
