...
import MaximizingEfficiencyinColdStorage from "@/components/Blogs/MaximizingEfficiencyinColdStorage";

export async function generateMetadata() {
  return getMeta("/maximizing-efficiency-in-cold-storage-the-case-for-warehouse-automation");
}

export default function MaximizingEfficiencyinColdStorageCase() {
  return (
    <div>
      <main className="bg-[linear-gradient(360deg,#ebf7ff_50%,#fff_100%)]">
        ...
        <div className=" rounded-[40px] max-[480px]:pt-[20px] w-[95%] max-w-[105rem] mx-auto relative z-index-[99]">
          <Breadcrumbs pageKey="maximizing-efficiency-in-cold-storage-the-case-for-warehouse-automation" />
        </div>
        <div className=" overflow-hidden">
        <div className=" rounded-[40px] pt-[20px] w-[95%] max-w-[105rem] mx-auto">
          <Subbanner bannerKey="maximizing-efficiency-in-cold-storage-the-case-for-warehouse-automation" />
        </div></div>
        <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px] rounded-[40px] w-[95%] md:w-[80%] max-w-[105rem] mx-auto">
           <MaximizingEfficiencyinColdStorage />
        </div>
