...
import ConstructionMining from "@/components/CaseStudiesDetail/ConstructionMiningComponent";
import AutoSector from "@/components/CaseStudiesDetail/AutosectorComponent";
import CuttingToolManufacturer from "@/components/CaseStudiesDetail/CuttingToolManufacturerComponent";
import IndustrialDrivesManufacturer from "@/components/CaseStudiesDetail/IndustrialDrivesManufacturerComponent";
    ...
    <div>
      <main className="bg-[linear-gradient(360deg,#ebf7ff_50%,#fff_100%)]">
        ...
        <div className=" rounded-[40px] max-[480px]:pt-[20px] w-[95%] max-w-[105rem] mx-auto relative z-index-[99]">
          <Breadcrumbs pageKey="industrial-drives-manufacturer" />
        </div>
        <div className=" overflow-hidden">
          <div className=" rounded-[40px] pt-[20px] w-[95%] max-w-[105rem] mx-auto">
            <Subbanner bannerKey="industrial-drives-manufacturer" />
          </div>
        </div>
