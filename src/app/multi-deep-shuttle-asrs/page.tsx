  ...
  return (
    <div >
      <main className="bg-[#EBF7FF]">
        ...
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto"><Breadcrumbs pageKey="multi-deep-shuttle-asrs" /></div>
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto"><QuickLinks /></div>
        <div className=" rounded-[40px] pt-[20px] w-[95%] mx-auto"><PSubbanner page="multi-deep-shuttle-asrs" /></div>

        <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px] rounded-[40px] w-[95%] md:w-[80%] max-w-[105rem] mx-auto   "><ProductViewer
        features={iPhoneFeatures}
        initialFeature="colors"
      /></div>
        <div className="rounded-[40px] w-[90%] md:w-[80%] max-w-[105rem] mx-auto   "><AsrsPerform /></div>
        <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px]
         my-[50px] sm:my-[60px] md:my-[70px] lg:my-[80px] xl:my-[90px] 2xl:my-[100px] rounded-[40px] w-[95%] md:w-[80%] max-w-[105rem] mx-auto bg-[#198CB3]"><KeyActivities /></div>
        <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px] rounded-[40px] w-[95%] md:w-[80%] max-w-[105rem] mx-auto bg-[#fff]"><Benefits /></div>
        <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px] rounded-[40px] w-[95%] md:w-[80%] max-w-[105rem] mx-auto"><ProductGallery /></div>
        <div className="py-[50px] sm:py-[60px] md:py-[70px] lg:py-[80px] xl:py-[90px] 2xl:py-[100px]  rounded-[40px] w-[95%] md:w-[80%] max-w-[105rem] mx-auto"><FaqStatic /></div>
