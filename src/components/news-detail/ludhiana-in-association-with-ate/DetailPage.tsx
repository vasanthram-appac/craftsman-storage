...
export default function DetailPage() {
  ...
  const galleryImages = [
     `${ASSET_PREFIX}/images/news/ludhiana-ate-3.webp`,
     `${ASSET_PREFIX}/images/news/ludhiana-ate-2.webp`,
     `${ASSET_PREFIX}/images/news/ludhiana-ate-1.webp`,
     `${ASSET_PREFIX}/images/news/ludhiana-ate-4.webp`,
     `${ASSET_PREFIX}/images/news/ludhiana-ate-5.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Customer meet at Ludhiana in association with ATE</h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/ludhiana-in-association-with-ate.webp`}
          alt="Customer meet at Ludhiana in association with ATE"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >Craftsman Storage Systems strengthens its bond with customers in Ludhiana! Our customer meet, in association with ATE, was a wonderful opportunity to connect and discuss new possibilities. Take a look!</p>
      </div>
