...
export default function DetailPage() {
  ...
  const galleryImages = [
    `${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-1.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-2.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-3.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-4.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-5.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-6.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/craftsman-hosts-rishta-customer-meet-in-bangalore-main.webp`}
          alt="Rishta Customer Meet Bangalore"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >
          Craftsman successfully hosted the Rishta Customer Meet in Bangalore, bringing together our valued customers for a day of meaningful interaction and collaboration.
        </p>
      </div>
