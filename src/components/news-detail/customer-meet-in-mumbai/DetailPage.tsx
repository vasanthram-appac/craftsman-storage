...
export default function DetailPage() {
  ...
  const galleryImages = [
     `${ASSET_PREFIX}/images/news/meaningful-customer-meet-in-mumbai-june-2025-1.webp`,
    `${ASSET_PREFIX}/images/news/meaningful-customer-meet-in-mumbai-june-2025-2.webp`,
    `${ASSET_PREFIX}/images/news/meaningful-customer-meet-in-mumbai-june-2025-4.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Craftsman Storage hosted a Meaningful Customer Meet in Mumbai</h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/craftsman-storage-hosted-a-meaningful-customer-meet-in-mumbai.webp`}
          alt="Customer Meet in Mumbai"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >The RISHTA Customer Connect held in Mumbai was a warm and engaging event that celebrated long-standing partnerships. It was an evening of heartfelt conversations, shared memories, and mutual appreciation - thank you to everyone who was part of it.</p>
      </div>
