...
export default function DetailPage() {
  ...
  const galleryImages = [
    `${ASSET_PREFIX}/images/news/iws-expo-01.webp`,
    `${ASSET_PREFIX}/images/news/iws-expo-02.webp`,
    `${ASSET_PREFIX}/images/news/iws-expo-03.webp`,
    `${ASSET_PREFIX}/images/news/iws-expo-04.webp`,
    `${ASSET_PREFIX}/images/news/iws-expo-05.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Craftsman Storage Exhibited at IWS Expo 2025  </h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/iws-expo-main.webp`}
          alt="IWS Expo 2025"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >
       Craftsman Storage participated in the India Warehousing Show (IWS Expo) held from 26 - 28 June at Yashobhoomi, New Delhi. The event brought together key industry players and decision-makers from the warehousing and logistics sector. Visitors engaged with our solutions at Hall 2, Booth B14, and explored what’s next in smart warehousing.
        </p>
      </div>
