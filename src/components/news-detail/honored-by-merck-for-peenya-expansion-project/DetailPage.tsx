  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Craftsman Storage Honored by Merck for Peenya Expansion Project </h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/craftsman-storage-honored-by-merck-for-peenya-expansion-project-detail.webp`}
          alt="Honored by Merck for Peenya Expansion Project"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >A proud moment for Craftsman Storage as the company has been awarded a Certificate of Recognition by Merck for its key contribution to the Peenya Expansion Project.</p>
      </div>
