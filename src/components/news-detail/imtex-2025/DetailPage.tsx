...
export default function DetailPage() {
  ...
  const galleryImages = [
      `${ASSET_PREFIX}/images/news/imtex-2025-event6.webp`,
    `${ASSET_PREFIX}/images/news/imtex-2025-event5.webp`,
    `${ASSET_PREFIX}/images/news/imtex-2025-event1.webp`,
    `${ASSET_PREFIX}/images/news/imtex-2025-event3.webp`,
    `${ASSET_PREFIX}/images/news/imtex-2025-event2.webp`,
    `${ASSET_PREFIX}/images/news/imtex-2025-event4.webp`,
    ...
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        <p className="text-[15px] leading-[24px] text-center text-[#0087a7] rounded-[50px] px-[25px] py-[7px] w-fit mx-auto mt-[10px]">
          23 <sup>rd</sup> - 29 <sup>th</sup> Jan 2025
        </p>
        <h2
          ref={headingRef}
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/imtex-2025-main.webp`}
          alt="IMTEX 2025"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >We had an amazing time at IMTEX 2025, connecting with industry professionals and showcasing our innovative solutions to help solve your warehousing challenges!</p>
      </div>
