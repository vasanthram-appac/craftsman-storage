...
export default function DetailPage() {
  ...
  const galleryImages = [
     `${ASSET_PREFIX}/images/news/logimat-2025-1.webp`,
     `${ASSET_PREFIX}/images/news/logimat-2025-2.webp`,
     `${ASSET_PREFIX}/images/news/logimat-2025-3.webp`,
     `${ASSET_PREFIX}/images/news/logimat-2025-4.webp`,
     `${ASSET_PREFIX}/images/news/logimat-2025-5.webp`,
     `${ASSET_PREFIX}/images/news/logimat-2025-6.webp`,
     `${ASSET_PREFIX}/images/news/logimat-2025-7.webp`,
    ...
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        <p className="text-[15px] leading-[24px] text-center text-[#0087a7] rounded-[50px] px-[25px] py-[7px] w-fit mx-auto mt-[10px]">
          13 <sup>th</sup> - 15 <sup>th</sup> Feb 2025
        </p>
        <h2
          ref={headingRef}
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/logimat-thumbnail-2025.webp`}
          alt="LOGIMAT 2025"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >We had an incredible time showcasing our cutting-edge solutions, connecting with industry experts, and exploring the latest in intralogistics.</p>
      </div>
