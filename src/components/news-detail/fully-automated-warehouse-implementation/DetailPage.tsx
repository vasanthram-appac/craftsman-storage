...
export default function DetailPage() {
  ...
  const galleryImages = [
    `${ASSET_PREFIX}/images/news/textile-magazine-2025-1.webp`,
    `${ASSET_PREFIX}/images/news/textile-magazine-2025-2.webp`,
    `${ASSET_PREFIX}/images/news/textile-magazine-2025-3.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Craftsman Automation, in partnership with A.T.E ., has successfully implemented a fully automated warehouse for ENES Mills. </h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/textile-magazine-impact-2025.webp`}
          alt="Textile Magazine Impact 2025"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >
        This cutting-edge solution enhances storage, boosts supply chain efficiency, and meets global standards — setting a new precedent for Indian manufacturers.
        </p>
      </div>
