...
export default function DetailPage() {
  ...
  const galleryImages = [
    `${ASSET_PREFIX}/images/news/craftsman-storage-hosted-the-customer-connect-in-hyderabad-1-2025.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-storage-hosted-the-customer-connect-in-hyderabad-2-2025.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-storage-hosted-the-customer-connect-in-hyderabad-3-2025.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-storage-hosted-the-customer-connect-in-hyderabad-4-2025.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-storage-hosted-the-customer-connect-in-hyderabad-5-2025.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/craftsman-storage-hosted-the-customer-connect-in-hyderabad-main-2025.webp`}
          alt="Customer Connect in Hyderabad"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >
       Craftsman Storage successfully hosted a customer connect in Hyderabad, bringing together valued partners and clients. It was a great platform to exchange ideas and strengthen relationships.
        </p>
      </div>
