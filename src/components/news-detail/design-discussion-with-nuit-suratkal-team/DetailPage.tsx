  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Craftsman Storage Systems had a design discussion with NIT Suratkal Team</h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/nit-suratkal-team-main.webp`}
          alt="design discussion with NIT Suratkal Team"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >We had a productive discussion with the NIT Suratkal team at our Pune factory. It was all about new ideas and designs that would benefit businesses </p>
      </div>
