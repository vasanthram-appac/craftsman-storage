...
export default function DetailPage() {
  ...
  const galleryImages = [
     `${ASSET_PREFIX}/images/news/intralogistics-warehousing-expo-2025-pune1.webp`,
    `${ASSET_PREFIX}/images/news/intralogistics-warehousing-expo-2025-pune2.webp`,
    `${ASSET_PREFIX}/images/news/intralogistics-warehousing-expo-2025-pune4.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      <div className="mb-10">
        ...
        >Craftsman Storage Exhibited at Intralogistics & Warehousing Expo 2025 </h2>
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/intralogistics-warehousing-expo-2025-pune.webp`}
          alt="Intralogistics & Warehousing Expo 2025"
          width={1840}
          height={871}
      ...
      <div>
        ...
        >Craftsman Storage participated in the Intralogistics & Warehousing Expo 2025 held in Pune, showcasing its latest innovations in warehouse and storage solutions. The event drew strong industry interest, offering a platform for meaningful conversations and forward-looking solutions.</p>
      </div>
