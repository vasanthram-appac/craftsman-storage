...
export default function Breadcrumbs({ pageKey }: BreadcrumbsProps) {
  ...
  return (
    <ul className="flex flex-wrap gap-[5px] text-sm absolute bottom-[-50px] left-[3%] z-[999]  max-[1200px]:w-[50%] max-[1000px]:w-[60%]  max-[900px]:w-[70%]  max-[760px]:w-[50%]  max-[760px]:bottom-[-50px] max-[600px]:w-[65%]  max-[480px]:relative max-[480px]:w-[100%]">
