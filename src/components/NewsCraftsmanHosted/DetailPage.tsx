...
export default function DetailPage() {
  ...
  const galleryImages = [
    `${ASSET_PREFIX}/images/news/craftsman-hosted-rishta-customer-meet-in-ahmedabad-1.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosted-rishta-customer-meet-in-ahmedabad-2.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosted-rishta-customer-meet-in-ahmedabad-3.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosted-rishta-customer-meet-in-ahmedabad-4.webp`,
    `${ASSET_PREFIX}/images/news/craftsman-hosted-rishta-customer-meet-in-ahmedabad-5.webp`,
  ...
  return (
    <section className="w-[100%] sm:w-[95%] md:w-[85%] xl:w-[70%] mx-auto relative   ">
      ...
      >
        <Image
          src={`${ASSET_PREFIX}/images/news/craftsman-hosted-rishta-customer-meet-in-ahmedabad-main.webp`}
