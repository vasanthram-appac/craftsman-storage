      ...
      <>
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            This company is a star production house of Dhotis, Shirts, Inner
            Wears, Knit Wears, fabrics, Kids & Women's Collection, which is
            giving the value addition to the life style of every Indian.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            ...
            started with the wide exposure of dhotis, marketing them as the
            Indian cultural style and to reach from town to villages.
          </li>
        </ul>
      </>,
    ],
    problems: [
      <>
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Customer had already built-up Civil RCC building with (Ground + 2
            Floors) to handle warehouse + order handling / dispatch operations.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Customer wanted to handle multiple FG - SKU variants such as shirts,
            dhotis, inner garments & combo's
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Required storage capacity: 1.5 Lakhs Cubic Feet of Storage required
            by occupying only 50% of total available space
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Customer had built civil mezzanine (G+1) on the North side of the
            building on each floor for having floor wise operation & wanted our
            racks to interconnect with the mezzanine system
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Being RCC building and workplace included, customers wanted to have
            free space to access windows on periphery area of the building.
          </li>
        </ul>
      </>,
      ,
      ...
      <>
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[30px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Craftsman proposed the concept of Multi{" "}
              <Link
                href="/"
                className="text-[#000] font-semibold hover:text-[#505050fa] transition-all duration-300 text-nowrap">
                Shelving Racks{""}
              </Link>
              in each floor for the height of 17 feet (G+1)
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              This allowed customer to fully utilize the available vertical
              space in each floor as well as providing connection with civil
              mezzanine in each floor.
            </span>
          </li>
        </ul>
        <h4 className="text-[20px] font-semibold mb-[15px] text-[#232323]">
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[30px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Occupied only 45% of floor space and exceeded customer's target
              storage capacity and hence space saving was the key factory here.
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>Denser storage of SKU's in each level.</span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Providing connection with civil mezzanine was easier with the
              availability of Catwalk levels
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              ...
              <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[30px]">
                <li className="flex gap-[10px] items-start">
                  <Bullet />
                  <span>
                    Customer wanted to avoid too many uprights in the
                    cross-aisle area & building periphery area.
                  </span>
                </li>
                <li className="flex gap-[10px] items-start">
                  <Bullet />
                  <span>
                    Hence, we have taken support from civil beam, wherein our
                    upright will be mounted on a steel plate @ 2.2m from ground
                    level, thus providing access to windows on the periphery and
                    creating a clear 1.55m aisle for man & trolley movement on
                    the cross aisle.
                  </span>
                </li>
              </ul>
    ...
    benefits: (
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Understanding exact requirement of customer and proposing solution
            design.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
