...
export default function TextileFashion() {
  const Bullet = () => (
  ...
  const data = {
    ...
    banimg: `${ASSET_PREFIX}/images/case-studies/flipkart-img-01.webp`,

    intro: [
      <>
        One of the premium Knitting brands of South India to have a
        manufacturing facility of 1,50,000 sq.ft to export across various
        continents and countries like Europe, America, Middle East & Canada.
        Through the start of art Manufacturing facility, they have mastered
        their techniques to serve their customers with highest credibility.
      </>,
    ],
    problems: [
      <>
        Our client was in a motive to build a warehouse inside of their
        manufacturing premise closely to their knitting line to store Raw
        material as well as Semi-Finished good. Their conventional method of
        ground stacking possessed a serious threat to accessibility &
        accountability because of the scattered material occupancy at floor and
        also our client was facing a challenge to meet the dispatch requirements
        of 30 MT per day. This in turn instilled our client to find a single
        window storage solution provider to encounter the above mentioned areas
        of concern. The requirement was to provide a storage solution to house
        500 MT of material out of which 50% was allocated for RM and remaining
        for SFG respectively.
      </>,
      ,
    ],
    specifications: [
      <>
        Detailed site survey enabled us to design the Racking systems & Pallets
        with respect to their material size, handling & packing parameters. The
        solution was made in consideration with the process flow of material
        inside their plant
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[30px]">
          <li className="flex gap-[10px] items-start">
            ...
            <span>
              ...
              with G+2 configuration had been offered for the incoming RM in the
              form of YARN bags/Semi-finished fabrics through palletized
              arrangement
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Heavy Duty Shelving System The processed knitting rolls from
              knitting line of various diameters were provisioned to store in
              shelving levels appropriately
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Heavy Duty Pallets Completely designed & manufactured by CAL to
              meet our client’s operational requirement for both YARN & FINISHED
              FABRIC storage
            </span>
          </li>
        </ul>
    ...
    images: [
      `${ASSET_PREFIX}/images/case-studies/flipkart-img-02.webp`,
      `${ASSET_PREFIX}/images/case-studies/flipkart-img-03.webp`,
    ],

    benefits: (
      <>
        The desired Storage Capacity of 500 MT had been achieved with the
        customized racking set up for both YARN & FABRIC which improved their
        accountability & material traceability. Storing knitting rolls over the
        tailor made shelving system had enabled them to segregate rolls of
        various diameters. Being their first palletized high racking arrangement
        we CAL assisted them by providing sample setup to practically use and
        comprehend the proposed solution. The entire project scope of Design,
        Manufacturing and erection was under single channel of CAL and the
        project was handed over within 8 weeks of time.
      </>
    ),
  };
    ...
    <article
      ...
      <div>
        ...
        <section ref={addToRefs}>
          <h2
            itemProp="headline"
            className="text-[24px] sm:text-[26px] md:text-[28px] lg:text-[30px] 2xl:text-[34px]
        ...
        <div className="sticky top-[150px]">
          ...
          <div>
            <ul className="flex gap-[15px] items-center w-full justify-center mt-[20px]">
              <li>
                <Link
                  href="https://www.linkedin.com/company/appac-media/"
                  target="_blank"
                  className="flex items-center justify-center text-[#212121] w-[35px] h-[35px] block p-[5px] rounded-[50px] transition duration-300 ease-in-out hover:bg-[#0087a7] hover:text-[#fff]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={25}
                    height={25}
                ...
                <Link
                  ...
                  <svg
                    ...
                    <path
                      ...
                      strokeWidth={0.7}></path>
                  </svg>
                </Link>
              </li>
              <li>
                <Link
                  href="https://www.instagram.com/appac_mediatech/"
                  target="_blank"
                  className="flex items-center justify-center text-[#212121] w-[35px] h-[35px] block p-[5px] rounded-[50px] transition duration-300 ease-in-out hover:bg-[#0087a7] hover:text-[#fff]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  ...
                  <svg
                    ...
                    <path
                      fill="currentColor"
                      d="M.076 0H3.61l3.145 4.498L10.53 0h1.129L7.185 5.114L12 12H8.468L5.183 7.303L1.128 12H0l4.753-5.312zM1.47.706l7.404 10.588h1.733L3.203.706z"></path>
                  </svg>
                </Link>
              </li>
              <li>
                <Link
                  href="https://www.youtube.com/channel/UCv2LNwbfMOlEyxo8kIQ_MwA/featured"
                  target="_blank"
                  className="flex items-center justify-center text-[#212121] w-[35px] h-[35px] block p-[5px] rounded-[50px] transition duration-300 ease-in-out hover:bg-[#0087a7] hover:text-[#fff]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      d="m29.86 22l-9.72-5.596v11.192z"
                ...
                <Link
                  ...
                  <svg
                    ...
                    <g fill="none" stroke="currentColor" strokeWidth={1.5}>
                      <path
                        strokeLinejoin="round"
                        d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2S2 6.477 2 12c0 1.379.28 2.693.784 3.888c.279.66.418.99.436 1.24c.017.25-.057.524-.204 1.073L2 22l3.799-1.016c.549-.147.823-.22 1.073-.204c.25.018.58.157 1.24.436A10 10 0 0 0 12 22Z"></path>
