...
export default function EcommerceSolution() {
  ...
  const data = {
    ...
    intro: [
      "The customer is one of the largest e-commerce players in India. With a user base of over 400 million and a diverse portfolio spanning more than 80 product lines, the company has empowered millions of consumers, merchants, and small businesses to participate actively in the digital marketplace. Additionally, it holds substantial interests in one of India's leading payment apps, strengthening an ecosystem that facilitates seamless payments across various subsidiaries, including fashion, wholesale, and travel services.",
    ],
    problems: [
      <>
        Due to a high volume of activities, the customer faced significant
        storage capacity issues that impacted their market penetration and
        last-mile delivery capabilities. As demand in the industry continued to
        grow, they encountered a critical shortage of storage facilities.
        Furthermore, the need for business expansion across multiple states
        compounded the issue, placing additional strain on existing storage and
        slowing down operational processes.
      </>,
      ,
    ],
    specifications: [
      <>
        To address these storage challenges, a customized{" "}
        <Link
          href="/"
          className="text-[#000] font-semibold hover:text-[#505050fa] transition-all duration-300 text-nowrap">
          Multi-Purpose Racking{" "}
        </Link>
        system was recommended, designed to meet the needs of a diversified
        product range. This solution included a multi-tier system of G+4 levels,
        combining storage for both loose and palletized materials to optimize
        space and improve material flow. Additionally, process automation was
        implemented, including Autonomous Mobile Robots (AMRs), conveyors, and
        lifters, which collectively enhanced throughput and operational
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Enhanced Storage Capacity: The newly implemented storage facility
            substantially increased the customer’s storage capabilities.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Expanded Business Opportunities: Enabled the customer to manage
            larger business prospects and extend geographical coverage.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Increased Product Range and Efficiency: Enhanced storage efficiency
            allowed for a broader product range and reduced spillage, thus
            improving throughput.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Operational Efficiency Gains: Significant improvements in
            operational efficiency, especially in product load handling and
            storage management.
          </li>
        </ul>
        The customer is now recognized as a pioneer in the industry, boasting
        one of the most advanced and effective warehousing systems, a broader
        market reach, and a strong competitive edge.
      </>
    ),
  };
