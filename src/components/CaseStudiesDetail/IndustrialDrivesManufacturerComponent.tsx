...
export default function IndustrialDrivesManufacturer() {
  const Bullet = () => (
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323]! list-none mb-[40px]">
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>
              Earlier customer was using 102.19 sq m of area for storing the
              bins and cartons which includes smaller line items as well as
              regular inventory.
            </span>
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>
              Biggest challenge is to manage inventory for smaller items like
              stud, nuts, washers, rubber, clamps etc. which is there in the
              racks.
            </span>
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>
              In this the pick time is high which is directly or indirectly
              effecting the cost.
            </span>
          </li>
        </ul>
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323]! list-none mb-[40px]">
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>
              120 sq m space which was earlier used for stores is now been used
              in R&D Center
            </span>
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>Warehouse shifted outside the plant.</span>
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>3600 Class b & c items are placed in the machine.</span>
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            <span>Warehouse area with maintained 5s</span>
          </li>
        </ul>
      </>,
    ],
          ...
          <table className="w-full border border-[#ddd] text-[#232323] text-left border-collapse">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-[#ddd] px-4 py-3">12500</td>
              </tr>
              <tr>
                <td className="border border-[#ddd] px-4 py-3">
                  Machine Foot Print
              ...
              <tr>
                ...
                <td className="border border-[#ddd] px-4 py-3">83 / machine</td>
              </tr>
              <tr>
                <td className="border border-[#ddd] px-4 py-3">
                  Number of Machines
                </td>
                <td className="border border-[#ddd] px-4 py-3">2</td>
              </tr>
              <tr>
                <td className="border border-[#ddd] px-4 py-3">
                  Total Number Bin Stores
                </td>
                <td className="border border-[#ddd] px-4 py-3">3600</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>Installation Date : 17 –August -2019</span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>Machine Cycle (First machine) : 25981</span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>Machine Cycle (Second machine) : 19457</span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Customer Feedback : After installation of Craftsman
              <Link
                href="/"
                className="text-[#000] font-semibold hover:text-[#505050fa] transition-all duration-300 text-nowrap">
                Vstore
              </Link>
              access to article is improved which result high through put over
              the manual operation also we have saved our floor space that we
              are utilizing for the other operations
            </span>
          </li>
        </ul>
      </>
