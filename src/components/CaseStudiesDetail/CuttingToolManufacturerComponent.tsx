...
export default function CuttingToolManufacturer() {
  const Bullet = () => (
  ...
  const data = {
    ...
    banimg: `${ASSET_PREFIX}/images/case-studies/cutting-tool-industry.webp`,
    ...
    intro: [
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323]! list-none mb-[40px]">
          ...
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            Each die set consists of 4 or 5 No. of dies which they will use for
            the manufacturing of cutting tools based on the cutting tool design.
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />A total of 1400 die sets are present in their stock.
          </li>
          <li className="flex gap-[10px] items-start  text-[16px]  leading-[1.5] font-[400]!">
            <Bullet />
            For every shift stores person need to issue Avg. 20 No. of die sets
            for that shifts production.
          </li>
        </ul>
      </>,
    ],
    ...
    images: [
      `${ASSET_PREFIX}/images/case-studies/vstore-automation.webp`,
      `${ASSET_PREFIX}/images/case-studies/vstore-solution.webp`,
    ],
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Customer is using this machine for almost 2 years now, it has
            completed 45600 cycles, they are satisfied with the machine
            performance & our service support.
          </li>

          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Their major pain point of tracing the Diesets has solved now by
              using VSTORE WMS software.{" "}
              <Link
                href="/"
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Ergonomic handling has reduced the risk of damage & reduced the
            physical effort of issuer.
          </li>
        </ul>
      </>
    ),
