...
export default function AutoSector() {
  const Bullet = () => (
  ...
  const data = {
    title: "Auto Sector",
    banimg: `${ASSET_PREFIX}/images/case-studies/selective-project-1.webp`,

    intro: [
      "An automotive company seeks an effective solution for storing raw materials and finished goods. Their current storage system struggles with inefficiencies and delays. By implementing advanced warehousing technology, they aim to streamline inventory management.",
    ],
    problems: [
      "Ensuring fire safety with pallets securely inside the rack without overhang.",
      "Inadequate support for point load of heavy dies in existing shelving racks.",
      "Need to lift heavy dies of 1000kg each directly from the rack and feed them to the machine.",
    ],
    images: [
      `${ASSET_PREFIX}/images/case-studies/selective-project-2.webp`,
      `${ASSET_PREFIX}/images/case-studies/selective-project-3.webp`,
    ],
    solutions: [
      <>
        Implementation of{" "}
        ...
        with Mesh Decking to ensure material safety and fire safety
      </>,
      "Installation of Die Storage racks with fork entry bars to support heavy dies and facilitate easy lifting and feeding to the machine.",
      "Utilization of Shelving Racks with 4 Bend decking to provide proper support for small dies and prevent damage to the shelf.",
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Enhanced material Safety and fire safety with the use of mesh
            decking.
          </li>

          <li className="flex gap-[10px] items-start">
            <Bullet />
            Facilitated direct placement of small dies onto racks without shelf
            damage, thanks to four-bend decking.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Simplified handling of heavy dies by storing them directly on racks
            and feeding them directly to the machine using fork entry bars.
          </li>
        </ul>
      </>
    ),
