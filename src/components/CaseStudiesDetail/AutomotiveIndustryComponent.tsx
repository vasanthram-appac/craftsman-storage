...
export default function AutomotiveIndustry() {
  ...
  const data = {
    ...
    banimg: `${ASSET_PREFIX}/images/case-studies/automobile-industries.webp`,

    intro: [
      "Craftsman has fulfilled the storage needs of the world's leading equipment manufacturers of agricultural, construction, forestry and tractor automotive industries. It’s headquartered at Pune, & has manufacturing and services facilities across India.",
    ],
    problems: [
      "Our customer’s storage space has been exhausted due to manually operated store and this impacted their productivity.",
      "Their current storage space is 120 square meters. They need to reduce the storage space of C and D class articles and utilize them for production activity.",
      "Continuous increase in farm equipment product range decreased the picking accuracy.",
    ],
    images: [
      `${ASSET_PREFIX}/images/case-studies/automotive.webp`,
      `${ASSET_PREFIX}/images/case-studies/automoblie-industry.webp`,
    ],
    solutions: [
      "Craftsman installed VStore, a space-saving solution that is also flexible to future storage requirements.",
      <>
        The manually operated store was replaced with two{" "}
        <Link
          href="/vstore"
          className="text-[#000] font-semibold hover:text-[#505050fa] transition-all duration-300">
          VStore
        </Link>{" "}
        of 8m height occupying 20 square meters each, thus freeing up their
        valuable floor space.
      </>,
      "This transformed the “Man to Goods” method to “Goods to Man”, thus enabling high transparency, quick and reliable access to the articles. As a result, picking errors have been reduced significantly.",
      ,
    ],
    benefits: (
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            The modular Technology of VStore from Craftsman Automation enabled
            faster product delivery, improved stock control, minimized pick
            errors, efficient order picking, and shorter lead times.
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Installation Date: Dec-2018
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            No of Cycles of 1st VStore: More than 300,000 cycles
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            No of Cycles of 2nd VStore: More than 400,000 cycles
          </li>
        </ul>

        {/* Details Table */}
        <h4 className="text-[20px] font-semibold mb-[15px] text-[#232323]">
          Details of the VStore Installed
        </h4>

        <div className="overflow-x-auto mb-[60px]">
          <table className="w-full border border-[#ddd] text-[#232323] text-left border-collapse">
            <thead className="bg-[#f9f9f9]">
              <tr>
                <th className="border border-[#ddd] px-4 py-3 font-semibold">
                  ITEMS
                </th>
                <th className="border border-[#ddd] px-4 py-3 font-semibold">
                  DESCRIPTION (in mm)
            ...
            <tbody>
              <tr>
                <td className="border border-[#ddd] px-4 py-3">Tray Size</td>
                <td className="border border-[#ddd] px-4 py-3">
                  2440 X 865 X 55 (W X D X H)
                </td>
              </tr>
              <tr>
                <td className="border border-[#ddd] px-4 py-3">
                ...
                <td className="border border-[#ddd] px-4 py-3">8050</td>
              </tr>
              <tr>
                <td className="border border-[#ddd] px-4 py-3">
                  Machine Foot Print
              ...
              <tr>
                ...
                <td className="border border-[#ddd] px-4 py-3">54 / machine</td>
              </tr>
            </tbody>
          </table>
        </div>
