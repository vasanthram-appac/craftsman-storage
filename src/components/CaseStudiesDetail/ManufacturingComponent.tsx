...
export default function Manufacturing() {
  ...
  const data = {
    ...
    intro: [
      "A Stalwart of precision parts and machine components manufacturer originated from Europe expanding their Operations in West India in order to cater across our country and also to globally. They have a wide product portfolio of more than 5,50,000 variants and offering their solution for different industrial sectors.",
    ],
    problems: [
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            ...
            <span>
              ...
              - For storage of RM like Bars & Pipes with a length of more than
              15 feet
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Shelving Racks - For the storage of WIP material at the
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Pallet Racking System - For the storage of FG to achieve the
      ...
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Overall storage solution right from Raw Material to Work in
              Progress and Finished Goods were all well synchronized and in
              tandem. Special Solution for Storage of Metal Sheets using
              mechanics eased their storing and retrieval methodologies.
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Mobile compactors had enabled them to utilize more space with
              single aisle concept and accessibility control of items was
              introduced. With efficient space planning pallet racking system
              offers them utmost selectivity.
            </span>
          </li>
        </ul>
      </>
