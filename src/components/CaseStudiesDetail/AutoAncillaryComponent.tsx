...
export default function AutoAncillary() {
  const Bullet = () => (
  ...
  const data = {
    ...
    banimg: `${ASSET_PREFIX}/images/case-studies/mobile-pallet-racking-used-in-auto-ancillary.webp`,

    intro: [
      "A leading company in the manufacturing of turbochargers, has become synonymous with quality, affordability and dependability. It is a pioneer and the largest manufacturer of turbochargers in India, With over 60% market share.",
    ],
    problems: [
      "Our customer's storage space has been exhausted due to a Conventional Racking System and this impacted their productivity.",
      "Major Constraint in this project apart from pricing was on the timelines which was very crucial for them to decide on the vendor.",
      "Craftsman team promised to take up this Project with a commitment to finish the job within the said timings.",
    ],
    images: [
      `${ASSET_PREFIX}/images/case-studies/mobile-pallet-racking-used-in-auto-ancillary-1.webp`,
      `${ASSET_PREFIX}/images/case-studies/mobile-pallet-racking-used-in-auto-ancillary-2.webp`,
    ],
    solutions: [
      "Mobile Pallet Racking",
      "No. of Levels per Module: 8",
      "Total Pallet Locations: 1512 Nos.",
      <>
        {" "}
        Our Advantge Over Competitors{" "}
    ...
    benefits: (
      <>
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[60px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Effective utilization of the civil area of 20 x 20 Metres with truss
            bottom height 10 M (clear space)
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            Local availability & better after sales support.
          </li>
        </ul>
      </>
    ),
