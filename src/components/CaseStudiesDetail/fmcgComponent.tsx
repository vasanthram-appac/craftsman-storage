...
export default function FMCG() {
  ...
  const data = {
    ...
    specifications: [
      <>
        Multi Product Solution to cater all their key segments (like discrete
        cartons, Dense & conventional palletized storage) had been offered and
        as follows
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Drive-In storage system with 6 deeps to achieve Denser Storage to
              follow FIFO operation for consumer durables like detergents &
              soaps
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            ...
            <span>
              ...
              to maximize the storage capacity with G+5 configuration with a
              column height of 10m
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Shelving system for storage and retrieval of excess cartons from
              the pallets through manual handling
            </span>
          </li>
        </ul>
      </>,
    ...
    benefits: (
      <>
        Scalable racking solution: Single deep pallet racking system offered
        with a provision to be converted into double deep racking to store more
        pallets in the future if the need arises. With 6 deep Drive-In solution
        the usage of aisle spaces had been minimized. Storage Capacity had been
        increased to nearly twice the times of their earlier storage method.
        Handling efficiency of cartons and pallets had been increased
        significantly because of the effective space utilization which in turn
        improved the overall warehouse productivity. <br />
        ...
        <ul className="grid gap-[15px] mt-[15px] text-[#232323] list-none mb-[40px]">
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>
              Achieved an overall storage of 25,000 MT from its earlier capacity
              of 13,000 MT
            </span>
          </li>
          <li className="flex gap-[10px] items-start">
          ...
          <li className="flex gap-[10px] items-start">
            <Bullet />
            <span>13,500 Sqm Storage footprint created</span>
          </li>
        </ul>
      </>
    ),
