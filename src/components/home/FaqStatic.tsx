      ...
      <div className=" grid grid-cols-[100%]">
        <div className="faq-wrp grid gap-[10px] sm:gap-[20px]">
          {accordionItems.map((item) => (
            <div
              key={item.id}
              className={` bg-[#f1f1f1] px-[15px] sm:px-[25px]  p-[10px] sm:p-[20px] rounded-[20px] group transition-all duration-300 ${
            ...
            >
              ...
              >
                <div className="flex justify-between w-full items-center">
                  ...
                  <div
                    className={`rounded-full p-[8px] border border-[#f1f1f1] transition duration-300 w-[32px] h-[32px] sm:w-[38px] sm:h-[38px]  flex items-center justify-center ${
                      activeAccordion === item.id
                        ? ""
                        : " "
                    }`}
